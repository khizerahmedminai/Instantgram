    ...
    <div className='app'>
      <Modal open={openSignup} onClose={() => setOpenSignup(false)}>
        <div style={modalStyle} className={classes.paper}>
          ...
          <center className='authFooter'>
            <small>
              &copy; 2022 Instagram clone by{' '}
              <a href='mailto:khizeraminai@gmail.com'> Khizer Minai</a>
            </small>
          </center>
        </div>
      </Modal>
      <Modal open={openLogin} onClose={() => setOpenLogin(false)}>
        <div style={modalStyle} className={classes.paper}>
          ...
          <center className='authFooter'>
            <small>
              &copy; 2022 Instagram clone by <a href='mailto:bkrofegha@gmail.com'> Khizer Minai</a>
            </small>
          </center>
        </div>
      </Modal>
